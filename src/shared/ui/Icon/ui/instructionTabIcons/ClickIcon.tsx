...
interface IClickIconProps {
    className?: string
}

export const ClickIcon: FC<IClickIconProps> = ({className = ''}) => (
    <svg className={className} width="16" height="16" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <defs>
